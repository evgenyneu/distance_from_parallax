...
Figure 1: Distribution of distance values r, calculated from r = 1/p, where p is simulated parallax. The dashed red line is the true simulated distance. Left: fractional parallax measurement uncertainty f(p) = σ(p)/π = 0.03. Right: f(p) = 0.6.
